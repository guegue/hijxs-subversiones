...
<script>
    ...
    import map from '../components/ContentPage/Map';
    export default {
        name: 'ThirdSection',
        ...
        mounted() {
            console.log(this.idResourcesSite,' Mount');
        },
        watch: {
...
<style scoped>
    ...
    .div-timeline {
        border-radius: 5px;
        position: relative;
        background: url("https://img.elcomercio.pe/files/ec_article_multimedia_gallery/uploads/2018/07/27/5b5b9582813ca.jpeg") center no-repeat;
